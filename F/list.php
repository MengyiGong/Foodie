...
.itemlist .item { float:left; width:415px; } 
...
<body>
	...
	if (!$con)
      ...
      $sql = "select * from business where Busi_Status=\"Approved\"&&Busi_Categories='".$word."' limit 0, 4";
...
mysql_close($con);
?>
<a href="/F/FF/category.php" target="_blank">see more</a>
               </div>
            </div>
